...
{
    if((loginDTO.getMenuPermission(PermissionConstants.ADSL_CLIENT) !=-1)
      &&(loginDTO.getMenuPermission(PermissionConstants.ADSL_CLIENT_SEARCH) >= PermissionConstants.PERMISSION_FULL)) {
        hasPermission=true;
    }
}
if( !hasPermission ){
...
<jsp:include page="../../common/layout.jsp" flush="true">
	...
	<jsp:param name="body" value="../adsl/client/clientEditBody.jsp" />
