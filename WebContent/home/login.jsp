...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Welcome to BTCL Bangladesh Limited | Admin Login</title>
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="<%=request.getContextPath()%>">
                <img  class="img-responsive" style="height: 75%; display: inline-block; " src="<%=request.getContextPath()%>/assets/images/company-name.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="login-form" action="<%=request.getContextPath()%>/Login.do" method="post">
               ...
               <%--  <div class="from-group">
                ...
                <div class="form-actions">
                    <button type="submit" class="btn green-jungle  btn-block uppercase">Login</button>
                </div>
                 <div class="form-actions">
	                 <a href="<%=request.getContextPath() %>/ForgetPassword.do?method=forgetPassword" > Forgot Password? </a> &nbsp; &nbsp; &nbsp;
         ...
         <%--<div class="copyright quick-links">--%>
        	<%--<div class="alert alert-info">--%>
     		<%--<span>Quick Links:</span>--%>
        	<%--<a href="<%=context%>domain/search" class="font-blue-ebonyclay"><b>Domain Search</b></a>--%>
        	<%--<a href="<%=context%>common/payment/guideLines.jsp" class="font-blue-ebonyclay"><b>How to pay</b></a>--%>
     	<%--</div>--%>
        <%--</div>--%>
        <div class="copyright"> <%=Calendar.getInstance().get(Calendar.YEAR) %> @ BTCL Bangladesh Limited v 19.8.5</div>
