...
<%
	String requested = (String) session.getAttribute("description");
...
<div class="form-group">
	<label for="" class="control-label col-md-4 col-sm-4 col-xs-4">Description</label>
	<div class="col-md-8 col-sm-8 col-xs-8"> 
	    <input name="description" class="form-control" autocomplete="off" type="text" value="<%=requested%>">
	</div>
</div>
