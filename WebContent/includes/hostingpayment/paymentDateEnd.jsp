...
String paymentTime = (String)session.getAttribute("PYPAYMENTDATE_END");
...
<input type = "text" name="PYPAYMENTDATE_END" value="<%=paymentTime%>" class="form-control"/>
<span class="input-group-addon">
<script type="text/javascript">new tcal({
	'formname' : 'hostingPaymentForm',
	'controlname' : 'PYPAYMENTDATE_END'
});</script>
</span>
</div> 
</div>
