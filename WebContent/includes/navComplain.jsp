			...
			<div class="form-actions fluid">
				<div class="row">
					<div class="col-md-offset-2 col-md-10">
					        ...
					        <input type="submit" class="btn btn-search-btcl" value="Search" >
					        <input type="reset" class="btn btn-reset-btcl" value="Reset" >
					        </div>
					</div>
				</div>
			</div>
			...
			<html:form action="<%=action%>" method="POST"
				...
				<div class=" col-xs-12 col-md-4 pull-left">
					<div class="form-inline">
						...
						<input type="submit" class="btn btn-sm btn-search-btcl " value=" Go ">
					</div>
				</div>
			</html:form>
		</div>
