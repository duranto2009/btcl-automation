...
String orderTime = (String)session.getAttribute("IGSERVICESTARTTIMEEND");
...
<div class="form-group">
	<label for="" class="control-label col-md-4 col-sm-4 col-xs-4">Service Start Date To</label>
	<div class="col-md-8 col-sm-8 col-xs-8"> 
<div class='input-group'>
<input type = "text" name="IGSERVICESTARTTIMEEND" value="<%=orderTime%>" class="form-control"/>
