...
<%String clientID = (String)session.getAttribute("rcClientID");
if(clientID == null) clientID="";
%>
<tr>
	<td bgcolor="#deede6"
		style="font-family: Verdana; font-size: 8pt; font-weight: bold; padding-left: 3" align="left" height="25">User ID</TD>
	<td bgcolor="#deede6" align="left" height="25"><select size="1" name="rcClientID">
