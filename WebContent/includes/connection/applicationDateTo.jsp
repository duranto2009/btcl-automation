...
String requestTime = (String)session.getAttribute("applicationDateTo");
...
<div class="form-group">
	<label for="" class="control-label col-md-4 col-sm-4 col-xs-4">Application Date To</label>
	<div class="col-md-8 col-sm-8 col-xs-8"> 
<div class="input-group date ">
                  <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                  </div>
                  <input type="text"  name="applicationDateTo" class="form-control pull-right" id="applicationDateTo"  value =<%=requestTime %> >
                </div>
</div>
</div>
