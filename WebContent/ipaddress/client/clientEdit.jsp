...
{
    if((loginDTO.getMenuPermission(PermissionConstants.IPADDRESS_CLIENT) !=-1)
      &&(loginDTO.getMenuPermission(PermissionConstants.IPADDRESS_CLIENT_SEARCH) >= PermissionConstants.PERMISSION_FULL)) {
        hasPermission=true;
    }
}
if( !hasPermission ){
...
<jsp:include page="../../common/layout.jsp" flush="true">
	...
	<jsp:param name="body" value="../ipaddress/client/clientEditBody.jsp" />
