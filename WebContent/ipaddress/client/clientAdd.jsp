...
if(loginDTO.getUserID()>0){
    if((loginDTO.getMenuPermission(PermissionConstants.IPADDRESS_CLIENT) !=-1) &&(loginDTO.getMenuPermission(PermissionConstants.IPADDRESS_CLIENT_ADD) == PermissionConstants.PERMISSION_FULL)){
        hasPermission=true;
    }
    permission = loginDTO.getMenuPermission( PermissionConstants.IPADDRESS_CLIENT_ADD ) ;
}
if(loginDTO.getAccountID()>0){
	...
	for(HashMap<String, String> module : moduleListByClientID){
		if(module.containsKey(ModuleConstants.Module_ID_IPADDRESS+"")){
			hasPermission=false;
			break;
		}
	}
...
<%
  ...
  request.setAttribute("subMenu2","addIpaddressClientMenu"); 
%>
<jsp:include page="../../common/layout.jsp" flush="true">
	<jsp:param name="title" value="Add Client" /> 
	<jsp:param name="body" value="../ipaddress/client/clientAddBody.jsp" />
