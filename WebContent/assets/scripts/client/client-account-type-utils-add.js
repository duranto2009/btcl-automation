    ...
    $.each(data, function (index, value) {
        if (index === parseInt(globalVariableToStoreSelectedRegistrantSubCategory, 10) - 1) {
            registrantSubCategoryHTML += "<div class='col-md-4'>" +
                "<label class=checkbox-inline><input type=checkbox name='clientDetailsDTO.regSubCategory' value=" + value.key + " checked>" + value.value + "</label>" +
                "</div>";
        } else {
            registrantSubCategoryHTML += "<div class='col-md-4'>" +
                "<label class=checkbox-inline><input type=checkbox name='clientDetailsDTO.regSubCategory' value=" + value.key + ">" + value.value + "</label>" +
                "</div>";
        }
