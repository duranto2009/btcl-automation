...
if( loginDTO.getUserID()>0 )
{
    if(loginDTO.getMenuPermission( PermissionConstants.FORBIDDEN_WORD) != -1 
      ...
      &&( loginDTO.getMenuPermission( PermissionConstants.FORBIDDEN_WORD_SEARCH )>=PermissionConstants.PERMISSION_READ ) )
...
<jsp:param name="title" value="Forbidden Word Search" /> 
	<jsp:param name="body" value="../domain/forbiddenDomain/searchForbiddenWordBody.jsp" />
</jsp:include>