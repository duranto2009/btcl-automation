...
<div class="portlet box portlet-btcl ">
	<div class="portlet-title">
		<div class="caption">Forbidden Word</div>
	</div>
							...
							<div class="portlet-body">
								<div class="table-responsive">
									<form method="post" enctype="multipart/form-data"
										action="../../AddForbiddenWord.do?mode=addForbiddenWordUsingFile">
										<table
											...
											<tbody>
												...
												<tr>
													<td colspan="2">
														<div>
															<button
																class="btn btn-sm btn-success filter-submit margin-bottom">Add</button>
														</div>
													</td>
												</tr>
											</tbody>
					...
					<div class="col-md-6">
						<div class="portlet light bordered">
							<div class="portlet-title">
								<div class="caption caption-md">
									<i class="icon-bar-chart theme-font hide"></i> <span
										class="caption-subject font-blue-madison bold uppercase">Single Add </span>
								</div>
							</div>
							<div class="portlet-body">
								<div class="table-responsive">
									<form method="post"
										action="../../AddForbiddenWord.do?mode=addForbiddenWord">
										<table
											class="table table-striped table-bordered table-checkable dataTable no-footer"
											id="package">
											<thead>
