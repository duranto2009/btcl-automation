...
if( loginDTO.getUserID()>0 )
{
    if(loginDTO.getMenuPermission( PermissionConstants.FILTER_DOMAIN) != -1 
      ...
      &&( loginDTO.getMenuPermission( PermissionConstants.FILTER_DOMAIN_SEARCH )>=PermissionConstants.PERMISSION_READ ) )
...
<%
  ...
  request.setAttribute("subMenu2","filterDomainMenu"); 
%>
<jsp:include page="../../common/layout.jsp" flush="true">
<jsp:param name="title" value="Search Domain Search" /> 
	<jsp:param name="body" value="../domain/domainNameSearch/domainNameSearchBody.jsp" />
