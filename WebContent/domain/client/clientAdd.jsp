...
if(loginDTO.getUserID()>0){
    if((loginDTO.getMenuPermission(PermissionConstants.DOMAIN_CLIENT) !=-1) &&(loginDTO.getMenuPermission(PermissionConstants.DOMAIN_CLIENT_ADD) == PermissionConstants.PERMISSION_FULL)){
        hasPermission=true;
    }
    permission = loginDTO.getMenuPermission( PermissionConstants.DOMAIN_CLIENT_ADD ) ;
}
if(loginDTO.getAccountID()>0){
	...
	for(HashMap<String, String> module : moduleListByClientID){
		if(module.containsKey(ModuleConstants.Module_ID_DOMAIN+"")){
			hasPermission=false;
			break;
		}
	}
...
<jsp:include page="../../common/layout.jsp" flush="true">
	...
	<jsp:param name="body" value="../domain/client/clientAddBody.jsp" />
