...
if(loginDTO.getUserID()>0)
{
    if((loginDTO.getMenuPermission(PermissionConstants.FILTER_DOMAIN) !=-1)
      ...
      &&(loginDTO.getMenuPermission(PermissionConstants.FILTER_DOMAIN_ADD)>PermissionConstants.PERMISSION_READ))
...
<jsp:param name="title" value="Add Domain" /> 
	<jsp:param name="body" value="../domain/newDomain/addDomainBody.jsp" />
