...
if( loginDTO.getUserID()>0 )
{
    if(loginDTO.getMenuPermission( PermissionConstants.PACKAGE_TYPE) != -1 
      ...
      &&( loginDTO.getMenuPermission( PermissionConstants.PACKAGE_TYPE_ADD )>PermissionConstants.PERMISSION_READ ) )
...
<%
  ...
  request.setAttribute("subMenu3","addPackageTypeDomainMenu"); 
%>
