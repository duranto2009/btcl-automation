...
if(loginDTO.getUserID()>0)
{
    if((loginDTO.getMenuPermission(PermissionConstants.PACKAGE) !=-1) &&
    		(loginDTO.getMenuPermission(PermissionConstants.PACKAGE_ADD) >= PermissionConstants.PERMISSION_MODIFY )) {
...
<jsp:include page="../../common/layout.jsp" flush="true">
	...
	<jsp:param name="body" value="../domain/package/updateDomainPackageBody.jsp" />
</jsp:include>