...
<form class="form-horizontal" id="ReportForm"
			action="<%=request.getContextPath()%>/Log/GetReportTableData.do">
<div class="portlet box portlet-btcl">
	...
	<div class="portlet-body form">
			...
			<input type="hidden" id="countURL" name="countURL" value="Log/GetTotalResultCount.do">
			<div class="form-body">
				<div class="row">
<!-- 					<div class="col-md-6"> -->
<!-- 						<div class="col-md-8"> -->
