...
<html:form  styleId="fileupload" styleClass="form-horizontal" action="<%=actionName%>" enctype="multipart/form-data" method="POST">
	...
	<div class="portlet box portlet-btcl">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-user"></i>COLOCATION Registrant Information Edit
			</div>
		</div>
		<!-- /.box-header -->
                          	...
                          	<div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       	<div class="radio-list">
									<label class="radio-inline"> 
										<input type="radio" data-type="nid" data-text="<%=FileTypeConstants.TYPE_ID_NAME.get(FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_NID) %>" name="clientDetailsDTO.identityType" value="<%=FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_NID %>" class="identityType identityTypeInd"  />
										<%=FileTypeConstants.TYPE_ID_NAME.get(FileTypeConstants.DOMAIN_CLIENT_ADD.DOMAIN_CLIENT_ADD_NID) %>
									</label> 
									<label class="radio-inline"> 
										<input type="radio" data-type="passport" data-text="<%=FileTypeConstants.TYPE_ID_NAME.get(FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_PASSPORT) %>" name="clientDetailsDTO.identityType" value="<%=FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_PASSPORT %>" class="identityType identityTypeInd" />
										<%=FileTypeConstants.TYPE_ID_NAME.get(FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_PASSPORT) %>
									</label>
								</div>
                                    </div>
                              <!--/span-->
                                 ...
                                 <div class="col-md-9">
                                 		<html:select property="clientDetailsDTO.registrantType" styleClass="form-control border-radius ">
											<html:option value="0">Select</html:option>
										 	<%
											HashMap<Integer, String> companyMap = RegistrantTypeConstants.REGISTRANT_TYPE.get(ModuleConstants.Module_ID_COLOCATION);
                          	...
                          	<div class="col-md-6">
                                 <div class="form-group">
                                     ...
                                     <div class="col-md-9">
                                        	<div class="radio-list">
										<label class="radio-inline"> 
											<input type="radio" data-type="tin" data-text="<%=FileTypeConstants.TYPE_ID_NAME.get(FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_TIN) %>" name="clientDetailsDTO.identityType" value="<%=FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_TIN %>" class="identityType identityTypeCom"  />
											<%=FileTypeConstants.TYPE_ID_NAME.get(FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_TIN) %>
										</label> 
										<label class="radio-inline"> 
											<input type="radio" data-type="trade" data-text="<%=FileTypeConstants.TYPE_ID_NAME.get(FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_TRADE) %>" name="clientDetailsDTO.identityType" value="<%=FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_TRADE %>" class="identityType identityTypeCom" />
											<%=FileTypeConstants.TYPE_ID_NAME.get(FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_TRADE) %>
										</label>
										<label class="radio-inline">
											<input id="forwardingLetter" type="radio"  data-type="forwardingLetterFile" data-text="<%=FileTypeConstants.TYPE_ID_NAME.get(FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_FORWARDING_LETTER)%>"
													name="clientDetailsDTO.identityType" value="<%=FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_FORWARDING_LETTER%>"
													class="identityType identityTypeCom">
												<%=FileTypeConstants.TYPE_ID_NAME.get(FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_FORWARDING_LETTER)%>
										</label>
									</div>
                                     </div>
                               <!--/span-->
					...
					<div class="col-md-12">
					 	<div  id="nid" class="col-md-3 fileType" style="padding: 0px;">
								...
								<span class="btn btn-warning-btcl  fileinput-button">
									...
									<span> Add <%=FileTypeConstants.TYPE_ID_NAME.get(FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_NID) %> Documents </span> 
									<input class="jFile" type="file" name="<%=FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_NID %>" >
								</span>
							</div>
							<div  id="passport" class="col-md-3 fileType" style="padding: 0px;">
								...
								<span class="btn btn-warning-btcl  fileinput-button">
									<i class="fa fa-upload"></i>
									<span> Add <%=FileTypeConstants.TYPE_ID_NAME.get(FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_PASSPORT) %> Documents </span> 
									<input class="jFile" type="file" name="<%=FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_PASSPORT %>" >
								</span>
							</div>
							<div  id="tin" class="col-md-3 fileType" style="padding: 0px; display: none">
								...
								<span class="btn yellow  fileinput-button">
									<i class="fa fa-upload"></i>
									<span> Add  <%=FileTypeConstants.TYPE_ID_NAME.get(FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_TIN)  %>  Documents </span> 
									<input class="jFile" type="file" name="<%=FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_TIN %>" multiple>
								</span>
							</div>
							<div  id="trade" class="col-md-3 fileType" style="padding: 0px; display: none">
								...
								<span class="btn yellow  fileinput-button">
									<i class="fa fa-upload"></i>
									<span> Add  <%=FileTypeConstants.TYPE_ID_NAME.get(FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_TRADE)  %>  Documents </span> 
									<input class="jFile" type="file" name="<%=FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_TRADE %>" multiple>
								</span>
							</div>
							<div  id="forwardingLetterFile" class="col-md-3 fileType" style="padding: 0px; display: none">
								...
								<span class="btn yellow  fileinput-button">
									<i class="fa fa-upload"></i>
									<span> Add  <%=FileTypeConstants.TYPE_ID_NAME.get(FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_FORWARDING_LETTER)  %>  Documents </span> 
									<input class="jFile" type="file" name="<%=FileTypeConstants.COLOCATION_CLIENT_ADD.COLOCATION_CLIENT_ADD_FORWARDING_LETTER %>" multiple>
								</span>
							</div>
						...
						<jsp:include page="../../common/fileListHelperEdit.jsp" flush="true">
							<jsp:param name="entityTypeID" value="<%=EntityTypeConstant.COLOCATION_CLIENT%>" />	
