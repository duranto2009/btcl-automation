...
<div id=btcl-co-location-newapplication>
    <btcl-body title="Co-Location" subtitle='Close and Dismantle' v-cloak="true">
        <btcl-portlet>
            ...
            <template v-if="newapplication.client!==null">
                ...
                <template v-if="oldapplication!=null">
                    ...
                    <btcl-field title="Power" required="true" v-if="oldapplication.powerNeeded == false">
                        <label class="radio-inline"><input type="radio" name="powerRadio" :value="true" checked v-model="newapplication.powerNeeded" disabled>Yes</label>
                        <label class="radio-inline"><input type="radio" name="powerRadio" :value="false" v-model="newapplication.powerNeeded" disabled>No</label>
                    </btcl-field>
                    ...
                    <btcl-field title="Fiber" required="true" v-if="oldapplication.fiberNeeded == false">
                        <label class="radio-inline"><input type="radio" name="fiberRadio" :value="true" checked v-model="newapplication.fiberNeeded" disabled>Yes</label>
                        <label class="radio-inline"><input type="radio" name="fiberRadio" :value="false" v-model="newapplication.fiberNeeded" disabled>No</label>
                    </btcl-field>
                    ...
                    <btcl-field required="true" title="Floor Space" v-if="oldapplication.floorSpaceNeeded == false">
                        <label class="radio-inline"><input type="radio" name="floorSpaceRadio" :value="true" checked
                                                           v-model="newapplication.floorSpaceNeeded" disabled>Yes</label>
                        <label class="radio-inline"><input type="radio" name="floorSpaceRadio" :value="false"
                                                           v-model="newapplication.floorSpaceNeeded" disabled>No</label>
                    </btcl-field>
                    <template v-if="newapplication.floorSpaceNeeded">
<%--                        <btcl-info title="Existing Fiber Type" :text="oldapplication.ofcTypeDescription"></btcl-info>--%>
                        <btcl-info title="Floor Space Amount" :text="oldapplication.floorSpaceAmount"></btcl-info>
                    </template>
    ...
    var vue = new Vue({
        ...
        methods: {
            submitData: function () {
                ...
                axios.post(context + "co-location/close-connection.do", {
