<div id=btcl-application>
	<btcl-body title="Reconnect" subtitle="Application">
		<btcl-form :action="contextPath + 'nix/application/reconnect-edit.do'" :name="['application']" :form-data="[application]" :redirect="goView">
        	<btcl-portlet>
...
<script src=nix-application-edit.js></script>
