<div class="modal fade" id="ldgmModalUpgrade" role="dialog">
    <div class="modal-dialog modal-lg" style="width: 95%;">
        <div class="modal-content">
                                ...
                                <tr v-for="(localLoop, localLoopIndex) in office.localLoopList">
                                    ...
                                    <td>
                                        <select v-model="localLoop.popID"
                                            ...
                                            <option :value="pop.pop.ID"
                                                    v-for="pop in application.ifr"
                                                    v-if="pop.selected==1 && pop.office.id==localLoop.officeid">
                                                {{pop.popName}}
                                            </option>
                                        </select>
                                    ...
                                    <td>
                                        ...
                                        <p v-else-if="localLoop.src==2">
                                            <template v-if="checkIfAlreadyToLDPSelected(localLoop,office.localLoopList,localLoopIndex)">
            ...
            <div class="modal-footer">
                ...
                <br><br>
                <button type="button" class="btn btn-success" @click="processRequestForEFR('new-connection-process')">Save
                </button>
                ...
                <btcl-portlet>
                    <div class="table-responsive">
                        <table class="table table-fit table-bordered">
                            ...
                            <template v-for="(office,officeIndex) in content.officeList" >
                                <tr v-for="(localLoop, localLoopIndex) in office.localLoopList" :key="localLoopIndex">
                                    <%--<hr/>--%>
                                    <%--office start--%>
                                    <td>
                                        <select v-model="localLoop.officeid"
                                    ...
                                    <td>
                                        <select v-model="localLoop.popID"
                                            ...
                                            <option disabled value="-1"> Select POP</option>
                                            <option :value="pop.pop.ID"
                                                    v-for="(pop,index) in application.ifr"
                                                    v-if="pop.selected==1 && pop.office.id==localLoop.officeid">
                                                {{pop.popName}}
<%--                                                (Loop {{ index+1 }})--%>
                                            </option>
