...
<div id=btcl-application v-cloak="true">
	<btcl-body title="NIX Upgrade" subtitle="Application">
			<btcl-portlet>
...
<%--				<btcl-field required="true" title="Loop Provider">--%>
...
<%--				</btcl-field>--%>
		...
		<%--		<btcl-field title="Local Loops">
					<multiselect v-model="application.localLoop"
								 :options="nixLocalLoops"
								 :track-by=ID
								 label=label
								 :allow-empty="false"
								 :searchable=true
...
<%--
				<btcl-input title="Existing Port Type"
							:text.sync="application.oldPortType">
...
<script src="upgrade/nix-upgrade.js"></script>
