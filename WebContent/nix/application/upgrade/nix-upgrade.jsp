<%
  ...
  request.setAttribute("subMenu4","nix-application-upgrade-connection");
%>

<jsp:include page="../../../layout/layout2018.jsp" flush="true">

    <jsp:param name="title" value="NIX Upgrade" />
	<jsp:param name="body" value="../nix/application/upgrade/nix-upgrade-body.jsp" />
