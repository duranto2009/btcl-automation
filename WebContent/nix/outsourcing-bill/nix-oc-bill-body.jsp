<div id=btcl-application>
    <btcl-body title="NIX" subtitle='Outsourcing Bill'>
        <btcl-portlet>
        ...
        methods: {
            ...
            getConnectionByClientId: function (clientID) {
                if (clientID === undefined) {
                    ...
                    axios.get(context + 'nix/connection/get-active-connection-by-client.do?id=' + clientID)
                        .then(result => {
            ...
            getOCBill: function () {
                ...
                axios.get(context + 'nix/monthly-bill/monthly-outsource-bill-details.do?vendor='+this.client.key + '&month='+this.month+'&year='+this.year)
                    .then(result => {
                    ...
                    axios.get(context + 'nix/monthly-bill/monthly-outsource-bill-summary.do?vendor='+this.client.key + '&month='+this.month+'&year='+this.year)
                        .then(result => {
