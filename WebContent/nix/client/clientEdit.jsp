...
{
    if((loginDTO.getMenuPermission(PermissionConstants.NIX_CLIENT) !=-1)
      &&(loginDTO.getMenuPermission(PermissionConstants.NIX_CLIENT_SEARCH) >= PermissionConstants.PERMISSION_FULL)) {
        hasPermission=true;
    }
}
if( !hasPermission ){
...
<jsp:include page="../../common/layout.jsp" flush="true">
	...
	<jsp:param name="body" value="../nix/client/clientEditBody.jsp" />
