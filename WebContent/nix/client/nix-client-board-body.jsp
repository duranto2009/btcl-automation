<div id=btcl-application>
	<btcl-body title="NIX" :subtitle="'Client Board ('+ clientDetails.clientID +')'">
		...
		<btcl-portlet title="Contact Information">
			<div class="table-responsive">
				<table class="table">
			        <thead>
			            <tr><th></th><th>Registrant</th><th>Billing</th><th>Admin</th><th>Technical</th></tr>
			        </thead>
			        <tbody>
			            <tr>
			            	<th>Name</th>
			            	<td>{{registrantContactDetails.registrantsName}} {{registrantContactDetails.registrantsLastName}}</td>
			            	...
			            	<td>{{technicalContactDetails.registrantsName}} {{technicalContactDetails.registrantsLastName}}</td>
			            </tr>
			            <tr>
			            	<th>Mobile</th>
		...
		<div class=row>
			<div class=col-md-7>
				<btcl-portlet title="Connection">
					<div class="table-responsive" style="max-height:300px">
						<table class="table">
					        <thead>
					            <tr><th>#</th><th>Name</th><th>Bandwidth (Mbps)</th><th>Status</th></tr>
					        </thead>
					        <tbody>
					            <tr v-for="(connection, connectionIndex) in connectionList">
					                <td>{{ connectionIndex + 1 }}</td>
					                <td><a :href="contextPath + 'nix/connection/view.do?id=' + connection.ID">{{connection.name}}</a></td>
			...
			<div class=col-md-5>
				<btcl-portlet title="Temporary Disconnection">
					...
					<div class=well>
						<h4>TD Date: {{ (clientTDDate == 0 || typeof clientTDDate == "undefined" ) ? "Uncalculated" : new Date(clientTDDate).toLocaleDateString("ca-ES")}}</h4>
					</div>
				</btcl-portlet>
				...
				<btcl-portlet title="Account Summary">
					<div class="table-responsive" style="max-height:300px">
						<table class="table">
					        <thead>
					            <tr><th>Account</th><th>Balance (BDT)</th></tr>
					        </thead>
					        <tbody>
...
<script src=nix-client-board.js></script>
