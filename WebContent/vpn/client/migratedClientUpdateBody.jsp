...
<div class="portlet box portlet-btcl">
	<div class="portlet-title portlet-title-btcl">
		<div class="caption"><i class="fa fa-link" aria-hidden="true"></i> Update Migrated Client VPN</div>
	</div>
	<div class="portlet-body portlet-body-btcl form">
		<form class="form-horizontal" method="post"  action="../../MigratedClientUpdate.do">
			<input type="hidden" name="method" value="migrateVpnClient" />
			<div class="form-body">
				<div class="form-group">
					...
					<div class="col-sm-6">
					 	...
					 	<input id="clientId" type="hidden" class="form-control" name="vpnClientID" value="-1" required>
					</div>
				</div>
				<div class="form-group">
...
$(document).ready(function(){
	$("#clientIdStr").autocomplete({
		source : function(request, response) {
			...
			var formData = {};
			formData['name'] = term;
			formData['moduleID'] = <%=ModuleConstants.Module_ID_VPN%>;
			if (term.length >= 3) {
