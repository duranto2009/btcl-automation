...
else if( loginDTO.getUserID()>0 )
{
    if((loginDTO.getMenuPermission(PermissionConstants.DOMAIN_CLIENT) !=-1)
      ...
      &&(loginDTO.getMenuPermission(PermissionConstants.DOMAIN_CLIENT_SEARCH) >= PermissionConstants.PERMISSION_FULL)) {
...
<jsp:include page="../../common/layout.jsp" flush="true">
	...
	<jsp:param name="body" value="../vpn/client/clientEditBody.jsp" />
