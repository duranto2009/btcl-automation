...
<%
	String msg = null;
	String url = "vpn/monthly-bill/check";
	String navigator = SessionConstants.NAV_VPN_BILL_GENERATION_CHECK;
	...
	<div class="portlet-body">
		<div class="table-responsive">
			<table  class="table table-bordered table-striped">
				...
				<tbody>
					<%
					ArrayList data = (ArrayList) session.getAttribute(SessionConstants.VIEW_VPN_BILL_GENERATION_CHECK);
					if (data != null) {
					...
					<tr>
						<td>
							<a href="<%=context%>vpn/monthly-bill/view.do?id=<%=clientDetailsDTO.getClientID() %>"><%=clientDetailsDTO.getClientID()%></a>
...
<script src=vpn-monthly-bill-generateCheck.js></script>
