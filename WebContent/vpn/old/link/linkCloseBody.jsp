...
<div class="portlet box portlet-btcl">
	<div class="portlet-title portlet-title-btcl">
		<div class="caption"><i class="fa fa-link" aria-hidden="true"></i> Link Close Request</div>
	</div>
	<div class="portlet-body portlet-body-btcl form">
		<form id="fileupload" class="form-horizontal" method="post" enctype="multipart/form-data" action="../../VpnLinkAction.do?mode=linkClose">
			<div class="form-body">
					<%
...
<%-- <script src="${context}assets/scripts/vpn/link/linkVsClientAutoComplete.js" type="text/javascript"></script> --%>
...
<%-- <script src="${context}assets/scripts/vpn/link/link-close-validation.js" type="text/javascript"></script> --%>
