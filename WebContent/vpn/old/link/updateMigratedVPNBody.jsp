...
<div class="portlet box portlet-btcl">
	<div class="portlet-title portlet-title-btcl">
		<div class="caption"><i class="fa fa-link" aria-hidden="true"></i> Update Migrated VPN</div>
	</div>
	<div class="portlet-body portlet-body-btcl form">
		<form id="fileupload" class="form-horizontal" method="post"  action="../../VpnLinkAction.do?mode=migratedVpnUpdate">
			<div class="form-body">
				<% if (loginDTO.getIsAdmin()) { %>
					<div class="form-group">
						<label for="cnName" class="col-sm-3 control-label">Client Name</label>
						<div class="col-sm-6">
					     	<input id="clientIDName"  placeholder="Client Name" type="text" class="form-control" name="clientIdStr"  required>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" id="vpnLinkIDName" placeholder="Link Name" class="linkName form-control" name="linkName" required>
				...
				<div class="form-group">
					<label for="cnName" class="col-sm-3 control-label">POP to POP Distance</label>
					<div class="col-sm-6">
						<input type="text"  placeholder="Total Distance" class=" form-control" name="totalDistance" required>
					</div>
				</div>
				
				<div class="form-group">
					<label for="cnName" class="col-sm-3 control-label">Near End Loop Distance</label>
					<div class="col-sm-6">
						<input type="text"  placeholder="Near End Loop Distance" class=" form-control" name="neLoopDistance" required>
					</div>
				</div>
				
				<div class="form-group">
					<label for="cnName" class="col-sm-3 control-label">Far End Loop Distance</label>
					<div class="col-sm-6">
						<input type="text"  placeholder="Far End Loop Distance" class=" form-control" name="feLoopDistance" required>
					</div>
				</div>
