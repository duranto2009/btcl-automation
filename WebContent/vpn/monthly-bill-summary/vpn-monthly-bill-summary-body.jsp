...
<div id=monthly-bill-summary>
    <btcl-body title="monthly bill Summary" subtitle="Monthly Bill Summary">
        <btcl-portlet>
            <btcl-field title="Client" v-if="isAdmin">
                <vpn-client-search :client.sync="monthlybillSummary.client">Select Client</vpn-client-search>
            </btcl-field>
    ...
    <div v-if="result" class="container" style="background:white;">
        ...
        <div id="monthLyBillTable" class="col-md-12 col-sm-12 col-xs-12"
             v-if="app.vpnMonthlyBillSummaryByItems.length>0">
...
<script src=vpn-monthly-bill-summary.js></script>
