var thirdTable = new Vue({
    ...
    methods: {
        viewMonthlyBillSummary () {
            ...
            //
            // window.open(context + 'pdf/vpn-monthly-bill.do?clientId=' + clientId+'&date='+suggestedDate, "_blank" );
            window.open(context + "pdf/view/monthly-bill.do?billId="+this.app.ID + "&module=6", "_blank" );
        },
        ...
        findSummaryOfTheMonth: function () {
            ...
            axios({
                method: 'GET',
                'url': context + 'vpn/monthly-bill-summary/search.do?id=' + clientId + '&date=' + suggestedDate
            })
                .then(result => {
                    ...
                    if (result.data.responseCode == 1) {
                        ...
                        if (this.app != null) {
                            var items = this.app.vpnMonthlyBillSummaryByItems;
                            ...
                            if (clientId > 0) {
                                axios({
                                    method: 'GET',
                                    'url': context + 'vpn/client/get-client-details.do?id=' + clientId
                                })
                                    .then(result => {
                                        if (result.data.responseCode == 1) {
