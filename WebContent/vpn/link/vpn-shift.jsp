<div id="btcl-vpn">
    ...
    <template v-else>
    <btcl-body title="VPN" subtitle='Shift' v-cloak="true">
        <btcl-portlet>
            ...
            <template v-if="application.client!=null">
                ...
                <template v-if="linkList.length>0">
                    ...
                    <template v-if="link!=null">
                        <%--<btcl-input title="Bandwidth(Mbps)" :text.sync="link.linkBandwidth" :number="true"></btcl-input>--%>
                    </template>
            ...
            <template v-if="link!=null">
                <jsp:include page="../common/view/view-shift-link-office-information.jsp"/>
            </template>

            <button type=button class="btn green-haze btn-block btn-lg" @click="submitShiftForm">Submit</button>
        </btcl-portlet>
    </btcl-body>
    </template>
</div>
<script src="../script/vpn-common.js" type="text/javascript"></script>
<script src="../script/vpn-shift.js" type="text/javascript"></script>
