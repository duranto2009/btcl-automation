...
{
    if((loginDTO.getMenuPermission(PermissionConstants.WEBHOSTING_CLIENT) !=-1)
    		
      &&(loginDTO.getMenuPermission(PermissionConstants.WEBHOSTING_CLIENT_SEARCH) >= PermissionConstants.PERMISSION_FULL)) {
...
<jsp:include page="../../common/layout.jsp" flush="true">
	...
	<jsp:param name="body" value="../webhosting/client/clientEditBody.jsp" />
