							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td width="100%" align="right"
										...
										<div class="div_title">Send Sms</div>
									</td>
								</tr>
								<tr>
											...
											<%
												String msg = null;
													if ((msg = (String) session
															.getAttribute(util.ConformationMessage.SMS_SENT)) != null) {
														session.removeAttribute(util.ConformationMessage.SMS_SENT);
											%>
											<tr>
