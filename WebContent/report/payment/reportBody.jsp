...
<form class="form-horizontal" id="ReportForm"
			action="<%=request.getContextPath()%>/report/GetPaymentReportTableData.do">
<div class="portlet box portlet-btcl">
	...
	<div class="portlet-body form">
			...
			<input type="hidden" id="countURL" name="countURL" value="report/GetPaymentTotalResultCount.do">
			<div class="form-body">
				<div class="row">
<!-- 					<div class="col-md-6"> -->
<!-- 						<div class="col-md-8"> -->
...
<!-- 					</div> -->
				...
				<div class="row">
					...
					<div class="col-md-6" id="display"><%@include
							file="reportPaymentDisplayDiv.jsp"%>
						<%
						%></div>
