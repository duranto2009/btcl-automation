...
<form class="form-horizontal" id="ReportForm"
			action="<%=request.getContextPath()%>/report/GetBillReportTableData.do">
<div class="portlet box portlet-btcl">
	...
	<div class="portlet-body form">
			...
			<input type="hidden" id="countURL" name="countURL" value="report/GetBillTotalResultCount.do">
			<div class="form-body">
				<div class="row">
				</div>
				<div class="row">
				...
				<div class="row">
					...
					<div class="col-md-6" id="display"><%@include file="reportBillDisplayDiv.jsp"%></div>
