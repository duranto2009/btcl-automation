...
if(moduleID == ModuleConstants.Module_ID_DOMAIN){
	...
	request.setAttribute("subMenu2","vpnBillReportMenu");
}
	...
	request.setAttribute("subMenu2","lliBillReportMenu");
}
	...
	request.setAttribute("subMenu2","colocationBillReportMenu");
}
	...
	request.setAttribute("subMenu2","nixBillReportMenu");
}
%> 

<jsp:include page="../../common/layout.jsp" flush="true">
	<jsp:param name="title" value="New Report" /> 
	<jsp:param name="body" value="../report/bill/reportBody.jsp" />
