...
<%
	...
	if(moduleID == ModuleConstants.Module_ID_VPN){
		...
		request.setAttribute("subMenu2","vpnReportMenuApplication");

	}
	else if(moduleID == ModuleConstants.Module_ID_LLI){
		request.setAttribute("menu", "lliMenu");
		request.setAttribute("subMenu1","lliReportMenu");
		request.setAttribute("subMenu2","lliApplicationReportMenu");
		...
		request.setAttribute("subMenu2","colocationApplicationReportMenu");
		...
		request.setAttribute("subMenu2","nixApplicationReportMenu");
		...
		request.setAttribute("subMenu2","upStreamApplicationReportMenu");
	}
%>
...
<jsp:include page="../../layout/layout2018.jsp" flush="true">
	...
	<jsp:param name="body" value="../report/application/report-body.jsp"/>
</jsp:include>
