...
<div class="portlet box portlet-btcl">
	<div class="portlet-title portlet-title-btcl">
		<div class="caption"><i class="fa fa-link" aria-hidden="true"></i> Link TD Request</div>
	</div>
	<div class="portlet-body portlet-body-btcl form">
		<form id="fileupload" class="form-horizontal" method="post" enctype="multipart/form-data" action="../../LliLinkAction.do?mode=linkEnable">
			<div class="form-body">
					<%
...
<!-- 					</div> -->
				...
				<div class="form-group">
					...
					<label for="lliDisabledLinkIDName" class="col-sm-3 control-label">
						Connection Name
					</label>
					
					<div class="col-sm-6">
						<input type="text" placeholder="Connection  Name" class="linkName form-control" id="lliDisabledLinkIDName" name="lliDisabledLinkIDName" required />
