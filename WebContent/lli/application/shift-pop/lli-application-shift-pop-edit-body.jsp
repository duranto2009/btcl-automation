<div id=btcl-application>
	<btcl-body title="Shift Pop" subtitle="Application">
		<btcl-form :action="contextPath + 'lli/application/shift-pop-edit.do'" :name="['application']" :form-data="[application]" :redirect="goView">
        	<btcl-portlet>
           		...
           		<btcl-field title="Select Existing Office">
