<div id=btcl-application>
	<btcl-body title="Process Application" :subtitle="'Application ID: ' + application.applicationID  + ' (' + application.applicationType.label + ')'">
		<div class=row>
			...
			<div class=col-md-4>
				<btcl-portlet title="Application">
		        	...
		        	<btcl-info title="Office" :text="application.office.label"></btcl-info>
		        	<btcl-info title="PoP" :text="application.oldpop.label"></btcl-info>
		        	<btcl-info title="New PoP" :text="application.newpop.label"></btcl-info>
			...
			<div class=col-md-8>
				<btcl-portlet title="Future Preview">
					<btcl-portlet>
		...
		<button type=button class="btn btn-block btn-lg green-haze" @click="process('shift-pop-process')">Save</button>
	</btcl-body>
</div>
