<div id=btcl-application>
	<btcl-body title="Additional Connection Address" subtitle="Application">
		<btcl-form :action="contextPath + 'lli/application/additional-connection-address.do'" :name="['application']" :form-data="[application]" :redirect="goView">
        	<btcl-portlet>
...
<script src=additional-connection-address/lli-application-additional-connection-address.js></script>
