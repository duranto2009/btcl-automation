<div id=btcl-application>
	<btcl-body title="Complete Request" :subtitle="'Application ID: ' + application.applicationID">
		<btcl-form :action="contextPath + 'lli/application/additional-connection-address-complete.do'" :name="['application']" :form-data="[application]" :redirect="submitCallback">
...
<script src=additional-connection-address/lli-application-additional-connection-address-completion.js></script>
