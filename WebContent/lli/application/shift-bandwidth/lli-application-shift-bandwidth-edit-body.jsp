<div id=btcl-application>
	<btcl-body title="Downgrade Bandwidth" subtitle="Application">
		<btcl-form :action="contextPath + 'lli/application/shift-bandwidth-edit.do'" :name="['application']" :form-data="[application]" :redirect="goView">
        	<btcl-portlet>
        		<btcl-info title="Client" :text="application.client.label" @loaded="getConnectionListByClient(application.client, true)"></btcl-info>
           		<btcl-field title="Source Connection">
           		...
           		<btcl-field title="Destination Connection">
           			<multiselect v-model="application.destinationConnection" :options="connectionOptionListByClientID" 
			        	:track-by=ID label=label :allow-empty="false" :searchable=true open-direction="bottom">
			        </multiselect>
           		</btcl-field>
