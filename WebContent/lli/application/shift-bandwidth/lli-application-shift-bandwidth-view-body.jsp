<div id=btcl-application>
	<btcl-body :title="application.applicationType.label" :subtitle="'Application ID: ' + application.applicationID">
       	<btcl-portlet>
        	...
        	<btcl-info title="Source Connection" :text="application.sourceConnection.label"></btcl-info>
        	<btcl-info title="Destination Connection" :text="application.destinationConnection.label"></btcl-info>
...
<script src=shift-bandwidth/lli-application-shift-bandwidth-view.js></script>
