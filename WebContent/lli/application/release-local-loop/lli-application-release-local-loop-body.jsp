<div id=btcl-application>
	<btcl-body title="Release Local Loop" subtitle="Application">
		
		<btcl-form :action="contextPath + 'lli/application/release-local-loop.do'" :name="['application']" :form-data="[application]" :redirect="goView">
        	<btcl-portlet>
...
<script src=release-local-loop/lli-application-release-local-loop.js></script>
