<div id=btcl-application>
	<btcl-body title="Upgrade Bandwidth" subtitle="Application Edit">
		<btcl-form :action="contextPath + 'lli/application/upgrade-bandwidth-edit.do'" :name="['application']" :form-data="[application]" :redirect="goView">
        	<btcl-portlet>
