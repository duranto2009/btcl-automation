<div id=btcl-application>
	<btcl-body title="Process Application" :subtitle="'Application ID: ' + application.applicationID  + ' (' + application.applicationType.label + ')'">
		<div class=row>
			...
			<div class=col-md-4>
				<btcl-portlet title="Application">
		        	...
		        	<btcl-info title="Extra Bandwidth (Mbps)" :text="application.bandwidth"></btcl-info>
		        	<btcl-info title="Duration (days)" :text="application.duration"></btcl-info>
		...
		<button type=button class="btn btn-block btn-lg green-haze" @click="process('temporary-upgrade-bandwidth-process')">Save</button>
	</btcl-body>
</div>
<script>
