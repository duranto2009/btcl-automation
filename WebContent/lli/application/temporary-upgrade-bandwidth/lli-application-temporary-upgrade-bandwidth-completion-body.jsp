<div id=btcl-application>
	<btcl-body title="Complete Request" :subtitle="'Application ID: ' + application.applicationID">
		<btcl-form :action="contextPath + 'lli/application/temporary-upgrade-bandwidth-complete.do'" :name="['application']" :form-data="[application]" :redirect="submitCallback">
...
<script src=temporary-upgrade-bandwidth/lli-application-temporary-upgrade-bandwidth-completion.js></script>
