<div id=btcl-application>
	<btcl-body title="Release Connection Address" subtitle="Application">
		...
		<btcl-form :action="contextPath + 'lli/application/release-connection-address.do'" :name="['application']" :form-data="[application]" :redirect="goView">
        	<btcl-portlet>
...
<script src=release-connection-address/lli-application-release-connection-address.js></script>
