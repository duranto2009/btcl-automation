<div id=btcl-application>
	<btcl-body title="Complete Request" :subtitle="'Application ID: ' + application.applicationID">
		<btcl-form :action="contextPath + 'lli/application/release-connection-address-complete.do'" :name="['application']" :form-data="[application]" :redirect="submitCallback">
...
<script src=release-connection-address/lli-application-release-connection-address-completion.js></script>
