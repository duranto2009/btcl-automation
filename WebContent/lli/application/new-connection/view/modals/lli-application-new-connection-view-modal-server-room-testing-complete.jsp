            ...
            <div class="modal-body">
                <div>
                    ...
                    <div class="form-body">
                        ...
                        <div v-if="application.applicationType.ID==2
                        && application.isNewLoop==true"
                             v-for="(element,index) in application.modifiedlocalloops" :key="index">
                            <btcl-portlet>
                                <btcl-field>
                                        ...
                                        <div class=row>
                                            ...
                                            <div class=col-sm-6>
                                                <select class="form-control" v-model="element.vlanType"
                                                        v-on:change="onChangeVlanType(application, element.vlanType,index)"
                                        ...
                                        <div class=row>
                                            ...
                                            <div class=col-sm-6>
                                                <select class="form-control"
                                                        v-model="element.router_switchID"
                                                        v-on:change="onChangeSwitchRouter(application,index)"
                                                        style="margin-top: 7px;"
                                                >
                        ...
                        <div v-if="application.isNewLoop==false"
                                v-for="(element,index) in application.localloops" :key="index">
                            <btcl-portlet>
                                <btcl-field>
                                    <div class="form-group">
                                        <div class=row>
                                        ...
                                        <%
                                            //todo :loop provider siginificence check for commented line below
                                        %>
                                        <div class=row>
                                            <label class="col-sm-4 control-label"
                                                   style="text-align: left;">OFC
                                        ...
                                        <div class=col-sm-10>
                                                ...
                                                <div class=col-sm-8>
                                                    <select class="form-control" v-model="regionID"
                                                        ...
                                                        <option v-bind:value="region.key"
                                                                v-for="region in ipRegionList">{{region.value}}
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class=row>
                                                <label class="col-sm-4 control-label" style="text-align: left;">IP
                                                    Version</label>
                                                <div class=col-sm-8>
                                                    <select class="form-control" v-model="ipVersion"
                                                            style="margin-top: 7px;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class=col-sm-8>
                                                            ...
                                                            <%--class="form-control"--%>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-10">{{ip.fromIP}} - {{ip.toIP}}
                                                                    </div>
                                                                    <div class="col-sm-2">
                                                                        <button @click="ipAvailableDelete(index)"
...
<%--server room testing complete for new localoop--%>
<div class="modal fade" id="serverRoomTestingCompleteForNewLocalLoop" role="dialog">
    <div class="modal-dialog modal-lg" style="width: 50%;">
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div>
                    <div class="portlet-title">
                        <div class="caption" align="center"
                             style="background: #fab74d;padding: 10px;">New Local Loops
                        </div>
                        <div class="tools">
                            <a href="javascript:;" data-original-title="" title="" class="collapse"></a>
                        </div>
                    ...
                    <div class="form-body">
                        <div v-for="(element,index) in application.newlocalloops" :key="index">
                            <btcl-portlet>
                                <btcl-field>
                                    <div class="form-group">
                                        <div class=row>
                        ...
                        <div v-if="application.applicationType.ID==1">
                            <%--    assign ip address--%>
                            <div class="caption" align="center"
                                 style="padding: 10px;font-weight: bold;font-size: 15px      ;">
                                IP Assign
            ...
            <div class="modal-footer">
                <%--<button type=button class="btn btn-success" @click="processRequestForEFR('new-connection-process')">Save</button>--%>
                <button type=button class="btn btn-success"
                        @click="testingCompleteNextStepForNewLocalLoop">
                    Submit
                </button>
                <button type="button" class="btn btn-danger" data-dismiss="modal">Close
                </button>
...
<%--serverRoomTestingCompleteAdditionalIP--%>
<div class="modal fade" id="serverRoomTestingCompleteAdditionalIP" role="dialog">
    <div class="modal-dialog modal-lg" style="width: 50%;">
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div>
                    <div class="portlet-title">
                        <div class="caption" align="center"
                             style="background: #fab74d;padding: 10px;">Additional IP
                        </div>
                        <div class="tools">
                            <a href="javascript:;" data-original-title="" title="" class="collapse"></a>
                        </div>
                    ...
                    <div class="form-body">
                        ...
                        <div v-if="
                        application.applicationType.ID==TYPE_FACTORY.ADDITIONAL_IP">
                            <%--    assign ip address--%>
                            <div class="caption" align="center"
                                 style="padding: 10px;font-weight: bold;font-size: 15px      ;">
                                IP Count: {{application.ipCount}}
                            </div>
                        </div>
                        <div v-if="
                        application.applicationType.ID==TYPE_FACTORY.ADDITIONAL_IP">
...
<%--                            </btcl-portlet>--%>
            ...
            <div class="modal-footer">
                <%--<button type=button class="btn btn-success" @click="processRequestForEFR('new-connection-process')">Save</button>--%>
                <button type=button class="btn btn-success"
                        @click="testingCompleteNextStepForIP">
                    Submit
                </button>
                <button type="button" class="btn btn-danger" data-dismiss="modal">Close
                </button>
