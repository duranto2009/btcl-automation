<div id=btcl-application>
	<btcl-body title="Process Application" :subtitle="'Application ID: ' + application.applicationID  + ' (' + application.applicationType.label + ')'">
		<div class=row>
			...
			<div class=col-md-4>
				<btcl-portlet title="Application">
		        	...
		        	<btcl-info title="Bandwidth to be Degraded (Mbps)" :text="application.bandwidth"></btcl-info>
		...
		<button type=button class="btn btn-block btn-lg green-haze" @click="process('downgrade-bandwidth-process')">Save</button>
	</btcl-body>
</div>
<script>
