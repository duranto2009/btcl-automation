<div id=btcl-application>
	<btcl-body title="Complete Request" :subtitle="'Application ID: ' + application.applicationID">
		<btcl-form :action="contextPath + 'lli/application/downgrade-bandwidth-complete.do'" :name="['application']" :form-data="[application]" :redirect="submitCallback">
...
<script src=downgrade-bandwidth/lli-application-downgrade-bandwidth-completion.js></script>
