<div id=btcl-application>
	<btcl-body title="Downgrade Bandwidth" subtitle="Application">
		<btcl-form :action="contextPath + 'lli/application/downgrade-bandwidth-edit.do'" :name="['application']" :form-data="[application]" :redirect="goView">
        	<btcl-portlet>
        		<btcl-info title="Client" :text="application.client.label" @loaded="getConnectionListByClient(application.client, true)"></btcl-info>
           		...
           		<btcl-input title="Bandwidth to be decreased (Mbps)" :text.sync="application.bandwidth"></btcl-input>
