<div id=btcl-application>
	<btcl-body :title="application.applicationType.label" :subtitle="'Application ID: ' + application.applicationID">
       	<btcl-portlet>
        	...
        	<btcl-info title="Bandwidth to be downgraded (Mbps)" :text="application.bandwidth"></btcl-info>
...
<script src=downgrade-bandwidth/lli-application-downgrade-bandwidth-view.js></script>
