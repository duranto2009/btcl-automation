<div id=btcl-application>
	<btcl-body title="Complete Request" :subtitle="'Application ID: ' + application.applicationID">
		<btcl-form :action="contextPath + 'lli/application/additional-local-loop-complete.do'" :name="['application']" :form-data="[application]" :redirect="submitCallback">
...
<script src=additional-local-loop/lli-application-additional-local-loop-completion.js></script>
