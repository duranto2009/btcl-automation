...
else if( loginDTO.getUserID()>0 )
{
    if((loginDTO.getMenuPermission(PermissionConstants.LLI_CLIENT) !=-1)
      &&(loginDTO.getMenuPermission(PermissionConstants.LLI_CLIENT_SEARCH) >= PermissionConstants.PERMISSION_FULL)) {
        hasPermission=true;
    }
}
if( !hasPermission ){
...
<jsp:include page="../../common/layout.jsp" flush="true">
	...
	<jsp:param name="body" value="../lli/client/clientEditBody.jsp" />
