...
<html:form styleId="fileupload" styleClass="form-horizontal" action="<%=actionName%>" enctype="multipart/form-data" method="POST">
	...
	<div class="portlet box portlet-btcl">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-user"></i>LLI Registration Information
			</div>
		</div>
		<!-- /.box-header -->
                                 ...
                                 <div class="form-group">
                                     ...
                                     <div class="col-md-9">
										...
										<label class="radio-inline"> 
											...
											<%=FileTypeConstants.TYPE_ID_NAME.get(FileTypeConstants.LLI_CLIENT_ADD.LLI_CLIENT_ADD_NID) %>
										</label> 
										<label class="radio-inline"> 
                          	...
                          	<div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       	<div class="radio-list">
											<label class="radio-inline"> 
												<input type="radio" data-type="tin" data-text="<%=FileTypeConstants.TYPE_ID_NAME.get(FileTypeConstants.LLI_CLIENT_ADD.LLI_CLIENT_ADD_TIN) %>" 
													 name="clientDetailsDTO.identityType"  value="<%=FileTypeConstants.LLI_CLIENT_ADD.LLI_CLIENT_ADD_TIN %>" class="identityType identityTypeCom" >
												<%=FileTypeConstants.TYPE_ID_NAME.get(FileTypeConstants.LLI_CLIENT_ADD.LLI_CLIENT_ADD_TIN) %>
											</label> 
											<label class="radio-inline"> 
												<input type="radio" data-type="trade" data-text="<%=FileTypeConstants.TYPE_ID_NAME.get(FileTypeConstants.LLI_CLIENT_ADD.LLI_CLIENT_ADD_TRADE) %>" 
													 name="clientDetailsDTO.identityType"  value="<%=FileTypeConstants.LLI_CLIENT_ADD.LLI_CLIENT_ADD_TRADE %>" class="identityType identityTypeCom" >
				...
				<div class="form-actions">
					<div class="row">
	                     <div class="col-md-offset-4 col-md-8">
							 	...
							 	<input type="hidden" name="clientDetailsDTO.moduleID" value="<%=ModuleConstants.Module_ID_LLI%>">
