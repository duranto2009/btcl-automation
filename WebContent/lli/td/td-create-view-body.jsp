        ...
        <%--<btcl-form :action="contextPath + 'lli/application/upgrade-bandwidth.do'" :name="['application']" :form-data="[application]" :redirect="goView">--%>
            <btcl-portlet>
                <btcl-field title="Client">
                    <lli-client-search :client.sync="td.client" :callback="clientSelectionCallback">Client</lli-client-search>
                </btcl-field>
                ...
                <btcl-field title="Adviced Date">
                    <btcl-datepicker :date.sync="td.tdAdvicedDate"></btcl-datepicker>
                </btcl-field>
                ...
                <%--</btcl-field>--%>
                <btcl-input title="Comment" :text.sync="td.comment"></btcl-input>
                <btcl-field>
                <div align="right">
...
<script>
    var vue = new Vue({
        ...
        methods: {
            submitData: function () {
                var url = "tdrequest";
                axios.post(context + 'lli/td/' + url + '.do', {'data': JSON.stringify(this.td)})
                    .then(result => {
