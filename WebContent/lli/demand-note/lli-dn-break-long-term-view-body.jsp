<div id=btcl-application>
	<btcl-body title="Short Bill View" subtitle='Break Long Term'>
	<btcl-portlet>
		<btcl-info title="Application ID" :text="app.applicationID"></btcl-info>
		<btcl-info title="Contract ID" :text="app.contract.ID"></btcl-info>
		<btcl-info title="Client" :text="billDTO.clientID"></btcl-info>
		<btcl-info title="Broken Bandwidth (Mb)" :text="app.bandwidth"></btcl-info>
		<btcl-info title="Short Bill"></btcl-info>

		<btcl-info title="Contract Breaking Fine" :text="billDTO.contractBreakingFine"></btcl-info>
...
<script src="../demand-note/lli-dn-break-long-term-view.js"></script>
