<div id=btcl-application>
	<btcl-body title="Demand Note View" subtitle='Ownership Change'>
	<btcl-portlet>
		<btcl-info title="Application ID" :text="app.applicationID"></btcl-info>
		<btcl-info title="Client" :text="app.client.label"></btcl-info>

		<btcl-info title="Ownership Change Charge" :text="billDTO.ownerShipChangeCharge"></btcl-info>
		<btcl-info title="Others" :text="billDTO.otherCosts"></btcl-info>
...
<script src="../demand-note/lli-dn-ownership-change-view.js"></script>
