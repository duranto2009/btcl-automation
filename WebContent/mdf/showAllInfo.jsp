            ...
            <div class="div_title">Exchange Information</div>
                                    ...
                                    <table width="595" class="table_view">
                                        ...
                                        <%
                                            ...
                                            ArrayList<MDFDTO> data = (ArrayList<MDFDTO>) fservice.getAll(loginDTO);
                                            if (data != null) {
                                                int size = data.size();
                                        ...
                                        %>
                                        <tr>
                                        <%if(row.getRefID()!= -1 && row.getJobType() == MDFDTO.JOB_TYPE_DISCONNECT_SHIFTED_OUT) 
                                        {
                                       ...
                                       <%}else{ %>
                                        ...
                                        <%}%>
                                            ...
                                            <td class="td_viewdata1" align="center" width="110" height="15">
                                                <%= row.getIsDone()?"Done":"Not Done"%>
                                            </td>   
                                            
                                               <td class="td_viewdata1" align="center" width="110" height="15">
                                                <%= row.getIsDone()?formatter.format(new Date(row.getDoneTime())):"-----"%>
                                            </td>                                    
                                        </tr>
                                        <%
                                                }
