...
<html:base />
			...
			LoginDTO loginDTO = (LoginDTO) request.getSession(true).getAttribute(SessionConstants.USER_LOGIN);
				String msg = null;
				String url = "SearchNote";
				String navigator = SessionConstants.NAV_NOTE;
			...
			<html:form action="/DropClient" method="POST">				
					<div class="table-responsive">
						<table id="example1" class="table table-bordered table-striped table-hover">
							...
							<tbody>
								<%
								ArrayList data = (ArrayList) session.getAttribute(SessionConstants.VIEW_NOTE);
								...
								<tr>
									...
									%>
									<% String link = RequestUtilService.getNoteLink( request.getContextPath(), row.getRequestTypeID(), row.getReqID(), row.getEntityTypeID(), row.getEntityID());
									link = (link == null ? RequestActionStateRepository.getInstance().getActionStateDTOActionTypeID(row.getRequestTypeID()).getDescription() :link );
									%>
									<td><%=link%> </td>									
