...
<%@page import="java.util.*,lli.configuration.*,java.text.*"%>
<%
	LLIFixedCostConfigurationDTO dto = (LLIFixedCostConfigurationDTO) request.getAttribute("latestDTO");
	LLIFixedCostConfigurationDTO active = (LLIFixedCostConfigurationDTO) request.getAttribute( "activeCharge" );
	List<LLIFixedCostConfigurationDTO> allCharges = (List<LLIFixedCostConfigurationDTO>) request.getAttribute("allCharges");
%>
<div class="portlet box portlet-btcl ">
	...
	<%
		if( active != null ){
	%>
		<form role="form" class="form-horizontal" mehtod="POST">
			...
			<%
				for( LLIFixedCostConfigurationDTO commonCharge: allCharges ){
			%>
	...
	<%} %>
		<form id="newCostForm" role="form" action="../UpdateCommonChargeConfigLLI.do" class="form-horizontal" mehtod="POST">
