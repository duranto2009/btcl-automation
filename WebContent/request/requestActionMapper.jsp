<div class="col-md-12">
	<c:forEach var="action" items="${ actions }">
		...
		<!-- /.box -->
		<!-- edit -->
		<c:if test="${action.actionTypeID == 65002  || action.actionTypeID == 65003}">
			<div class="portlet" id="link_action_${action.actionTypeID }" style="display: none;">
				<a class="btn btn-primary btn-block"
					href="${context}VpnLinkAction.do?id=15010&amp;getMode=showEditPage&amp;isEditable">Edit</a>
			</div>
		</c:if>
		<!-- /.box -->
		<!-- lli.Application.ownership change -->
		<c:if test="${action.actionTypeID == 60100}">
			<div class="portlet" id="link_action_${action.actionTypeID }" style="display: none;">
