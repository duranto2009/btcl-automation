                  			...
                  			<table border="0" cellpadding="0" cellspacing="0" width="100%">
                    			<tr>
                    				<td width="1024" align="right" style="border-left-width: 1; border-right-width: 1; border-top-width: 1; border-bottom: 1px solid #C0C0C0">
                      					<div class="div_title">Download Reports</div>
            						</td>
            					</tr>
								<tr>
									...
									<html:form action="/Download" method="POST" onsubmit = "return validate();">
											...
											<table width="500" border="0" cellpadding="0" cellspacing="0" id = "AutoNumber3">
												 <%
                                                        String msg = null;
                                                        if ((msg = (String) session.getAttribute("scheduledReportDownload")) != null) {
                                                            session.removeAttribute("scheduledReportDownload");
                                                    %>
                                                    <tr>
                                                    ...
                                                    <td height="25" align="left"> 
			            									 		<html:select property = "reportTypeSelected" size="1">
			            									 			<html:option value="Individual_Bills">Individual Bills</html:option>
			            									 			<html:option value="Combined_Bills">Combined Bills</html:option>
			            									 			<html:option value="Client_Modification_Reports">Client Modification Reports</html:option>
			            									 			<html:option value="Client_Statistics_Reports">Client Statistics Reports</html:option>
			            									 			<html:option value="Summary_Reports">Summary Reports</html:option>
			                        								</html:select> 
			                        							</td>
                                                    </tr>
                                                   <tr>
