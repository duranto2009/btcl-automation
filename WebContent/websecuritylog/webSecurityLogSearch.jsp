...
<%
  ...
  request.setAttribute("subMenu2","webSecurityLogSearch");
%>
<jsp:include page="../common/layout.jsp" flush="true">
	<jsp:param name="title" value="Web Security Log Search" /> 
	<jsp:param name="body" value="../websecuritylog/webSecurityLogSearchBody.jsp" />
