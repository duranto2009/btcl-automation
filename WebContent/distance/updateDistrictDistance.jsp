...
if((ModuleConstants.Module_ID_VPN+"").equals(request.getParameter("moduleID"))){
	...
	request.setAttribute("subMenu3","districtDistanceSubmenu2");  
...
<jsp:param name="title" value="Update Distance between Districts" /> 
	<jsp:param name="body" value="../distance/updateDistrictDistanceBody.jsp" />
</jsp:include> 
