...
if((ModuleConstants.Module_ID_VPN+"").equals(request.getParameter("moduleID"))){
	...
	request.setAttribute("subMenu3","unionDistanceSubmenu2");  
...
<jsp:param name="title" value="Update Distance from Upazila to Union" /> 
	<jsp:param name="body" value="../distance/updateUnionDistanceBody.jsp" />
</jsp:include> 
