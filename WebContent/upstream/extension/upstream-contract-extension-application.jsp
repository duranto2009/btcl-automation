...
<%
    String msg = null;
    String url = "upstream/contract-extension";
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <a class="btn btn-primary"
                                   onclick="get_contract_info(<%=upstreamContract.getContractId() %>); return false;"
                                   href="<%=context%>upstream/contract-details.do?id=<%=upstreamContract.getApplicationId() %>&type=details">
...
<div id="btcl-vpn" v-if="divShow">
    ...
    <template v-else>
        <btcl-body title="Upstream" subtitle='Contract Extension' v-cloak="true">
            <btcl-portlet>
                ...
                <template v-if="contract">
                    ...
                    <btcl-field title="Contract Extension">
                        <%--                        <btcl-datepicker :date.sync="contractExtensionTo" pattern="yyyy-MM-dd"></btcl-datepicker>--%>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4">
                                    <label class="col-md-3 control-label">Year </label>
                                    <div class="col-md-5">
                                        <input type="number" class="form-control input-small input-inline"
                                               v-model.number="application.year" value="0" placeholder="Enter Year">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-5">
                                        <input type="number" class="form-control input-small input-inline"
                                               v-model.number="application.month" value="0" placeholder="Enter Month">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-5">
                                        <input type="number" class="form-control input-small input-inline"
                                               v-model.number="application.day" value="0" placeholder="Enter Day"></div>
                                </div>
                            </div>
...
<script src="../upstream/scripts/upstream-contract-extension-application.js" type="text/javascript"></script>
