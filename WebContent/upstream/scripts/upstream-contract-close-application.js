var vue = new Vue({
    ...
    methods: {
        submitNewConnection: function () {
            ...
            // this.contract.contractDuration = this.contractExtensionTo;
            postObject({application: app}, context + 'upstream/submit-contract-close-request.do', context+'upstream/request-search.do', this);
