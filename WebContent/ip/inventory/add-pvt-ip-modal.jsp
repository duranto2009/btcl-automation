<div class="modal fade" id="pvt-ip-add-modal" role="dialog">
    <div class="modal-dialog modal-lg" style="width: 55%;">
        <div class="modal-content">
            <div class="portlet-title">
                <div class="caption" align="center"style=" background: #fab74d;padding: 10px;">Forward Advice Note</div>
                <div class="tools">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" @click="forwardAdviceNote()">Submit</button>
