...
@TableName("at_lli_application_release_connection_address")
@ForeignKeyName("parentApplicationID")
public class LLIReleaseConnectionAddressApplication extends LLIApplication implements SingleConnectionApplication{
	@PrimaryKey
	...
	public void insertApplication() throws Exception {
		this.setApplicationType(LLIConnectionConstants.RELEASE_CONNECTION_ADDRESS);
	...
	public void setImmutablePropertyWhileProcessing(LLIApplication lastApplicationSnapshot) throws Exception {
		if(!(lastApplicationSnapshot instanceof LLIReleaseConnectionAddressApplication)) {
		...
		LLIReleaseConnectionAddressApplication lliReleaseConnectionAddressApplication = (LLIReleaseConnectionAddressApplication) lastApplicationSnapshot;
		String content = this.getContent();
		ModifiedSqlGenerator.populateObjectFromOtherObject(lliReleaseConnectionAddressApplication, this, LLIReleaseConnectionAddressApplication.class);
		setContent(content);
	}
	@SuppressWarnings("static-access")
	@Override
	...
	public void completeApplication() throws Exception {
		...
		lliConnectionInstance.setIncident(LLIConnectionConstants.RELEASE_CONNECTION_ADDRESS);
