...
public class NewLongTermAdviceNote implements PdfMaterial {
    ...
    private static final String LLI_NEW_CONNECTION_ADVICE_NOTE_DIR = "lli/new-long-term/advice-note/";
    ...
    public NewLongTermAdviceNote(long applicationId) {
        this.outputFilePath = generateFilePath(applicationId);
    }
    ...
    public void populateData(RoleDTO roleDTO, ArrayList<String> membersOfCC, ClientDTO clientDTO) {
