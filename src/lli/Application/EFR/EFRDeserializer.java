...
//            efr.setVendorID(vendorID != null ? vendorID.getAsLong() : 0);
                ...
                efr.setWorkDeadline(workDeadline != null ? workDeadline.getAsLong() : java.lang.System.currentTimeMillis() + workExpireTime);
...
//            ValidationService.validateNonEmptyID(object, "ofcType", "OFC Type");
                ...
                efr.setWorkOrderNumber(object.has("workOrderNumber")? object.get("workOrderNumber").getAsLong():0);
