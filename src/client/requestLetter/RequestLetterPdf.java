...
@AllArgsConstructor
@NoArgsConstructor
public class RequestLetterPdf implements PdfMaterial {
...
//        params.put("footerRight", "Bangladesh Telecommunications Company Limited");
        ...
        //TODO: change if the format doesn't work
        params.put("disconnectionDate", new SimpleDateFormat("dd/MM/yyyy").
                format(new Date(this.params.get("disconnectionDate").getAsLong())));
    ...
    public String getResourceFile() {
        return BillConstants.REQUEST_LETTER_TEMPLATE;
    }
    ...
    public String getOutputFilePath() throws Exception {
        String proposedFileName = "reminder-letter" + this.params.get("clientId").getAsLong() + "-" + ".pdf";
