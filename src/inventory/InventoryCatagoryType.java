...
@TableName("at_inv_cat_type")
public class InventoryCatagoryType extends ActionForm implements Comparable<InventoryCatagoryType>{
	@PrimaryKey
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		InventoryCatagoryType other = (InventoryCatagoryType) obj;
		if (ID != other.ID)
			return false;
		return true;
	}
	...
	public String toString() {
		return "InventoryCatagoryType [ID=" + ID + ", name=" + name
				+ ", level=" + level + ", parentCatagoryTypeID="
				+ parentCatagoryTypeID + ", isDeleted=" + isDeleted
				+ ", lastModificationTime=" + lastModificationTime + "]";
	}
	@Override
	public int compareTo(InventoryCatagoryType o) {
