...
import note.NoteSearchService;
import request.RequestSearchService;
import sessionmanager.SessionConstants;
import sessionmanager.SessionManager;
import util.RecordNavigationManager;

public class SearchNoteAction extends Action{
    ...
    public ActionForward execute(ActionMapping p_mapping, ActionForm p_form, HttpServletRequest p_request, HttpServletResponse p_response) throws NumberFormatException, IOException{	
        ...
        NoteSearchService service = new NoteSearchService();
        ...
        RecordNavigationManager rnManager = new RecordNavigationManager(SessionConstants.NAV_NOTE, p_request, service, SessionConstants.VIEW_NOTE, SessionConstants.SEARCH_NOTE);
        try {
