...
public class VpnCommonChargeConfigDAO {
	...
	public CommonChargeDTO getLatestCommonChargeDTO(DatabaseConnection databaseConnection) throws Exception{
		List<CommonChargeDTO>list=(List<CommonChargeDTO>)SqlGenerator.getAllObjectList(CommonChargeDTO.class, databaseConnection," order by  "+ SqlGenerator.getColumnName(classObject, "activationDate")+" desc limit 1");
	...
	public List<CommonChargeDTO> getAllFutureCommonChargeDTOs(DatabaseConnection databaseConnection) throws Exception {
		...
		String conditionGetFuture  = " where " + activationDateColumnName + " > " + System.currentTimeMillis() + " and " + SqlGenerator.getColumnName(CommonChargeDTO.class, "isDeleted" ) + " = 0";
